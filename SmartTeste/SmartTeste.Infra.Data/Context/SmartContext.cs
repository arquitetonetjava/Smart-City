...
{
    public sealed class SmartContext : DbContext, IUnitOfWork
    {
        private readonly IMediatorHandler _mediatorHandler;

        public SmartContext(DbContextOptions<SmartContext> options, IMediatorHandler mediatorHandler) : base(options)
        {
